...
//           <div className="deal-card-wrapper" key={p.id}>
//             <Link to={`/product/${p.id}`} className="deal-card">
...
//                     key={i}
//                     className={`star ${
//                       i < Math.round(p.rating?.rate || 0) ? "filled" : ""
//                     }`}
//                   >
//                     ★
//                   </span>
...
//                   {p.rating?.rate?.toFixed(1) || "0.0"}
//                 </span>
//                 <span className="rating-count">({p.rating?.count || 0})</span>
//               </div>
...
//                   <span
//                     style={{
//                       color: isInWishlist(p.id) ? "orange" : "lightgray",
//                       fontSize: "1.3rem",
